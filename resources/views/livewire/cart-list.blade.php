          ...
          <div class="w-3/4 bg-white px-10 py-10">
            ...
            <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                ...
                <div class="flex justify-center w-1/5">
                  <button wire:click="updateCart({{ $productId }}, {{ $quantity - 1 }})"><svg class="fill-current text-gray-600 w-3" viewBox="0 0 448 512"><path d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"/>
                  </svg></button>
                  <input  class="mx-2 border text-center w-8 text-black" type="number" name="quantity" value="{{ $quantity }}" min="1" readonly>
                  <button wire:click="updateCart({{ $productId }}, {{ $quantity + 1 }})"><svg class="fill-current text-gray-600 w-3" viewBox="0 0 448 512">
                ...
                <span class="text-center w-1/5 font-semibold text-sm text-black">{{ $quantity*$food->amount }}</span>
              </div>
              @endif
              @endforeach
            @endforeach
