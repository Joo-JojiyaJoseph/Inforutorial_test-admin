...
@section('content')
    ...
    <section class="inner-banner">
        <div class="image-layer" style="background-image: url({{ asset('/storage/images/background/banner-image-2.jpg') }});">
        </div>
                ...
                @foreach ($dishes as $dish)
                    ...
                    <div class="offer-block-three col-xl-3 col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="0ms">
                            <div class="image"><a><img src="{{ asset('/storage/uploads/food/' . $dish->image) }}"
                                        alt=""></a></div>
